...
public class RockPaperScissorsFrame extends JFrame {
    ...
    private void CreateChoicePnl(){
        ...
        rockIco = new ImageIcon("src/rockIcon.png");
        ...
        rockBtn.addActionListener((ActionEvent ae) ->{
            ...
            if(aiChoice == 1){
                results.append("NPC Selected Rock.Tie Game!\n\n");
                tieCnt = tieCnt + 1;
            ...
            if(aiChoice == 3){
                results.append("Rock Breaks Scissors. You Win!\n\n");
                usrWinCnt = usrWinCnt + 1;
                usrWinField.setText(String.valueOf(usrWinCnt));
            }
        });

        paperIco = new ImageIcon("src/paperIcon.png");
        ...
        paperBtn.addActionListener((ActionEvent ae) ->{
            ...
            if(aiChoice == 2){
                results.append("NPC Selected Paper.Tie Game!\n\n");
                tieCnt = tieCnt + 1;
                tieCntField.setText(String.valueOf(tieCnt));
            }
            if(aiChoice == 3){
                results.append("Scissors Cuts Paper. AI Wins!\n\n");
                aiWinCnt = aiWinCnt + 1;
                aiWinField.setText(String.valueOf(aiWinCnt));
            }
        });

        scissorIco = new ImageIcon("src/scissorIcon.png");
        ...
        scissorBtn.addActionListener((ActionEvent ae) ->{
            ...
            aiChoice = rnd.nextInt(3) + 1;
            if(aiChoice == 1){
                results.append("Rock Breaks Scissors. AI Wins!\n\n");
                aiWinCnt = aiWinCnt + 1;
                aiWinField.setText(String.valueOf(aiWinCnt));
            }
            if(aiChoice == 2){
                results.append("Scissors Cuts Paper. You win!\n\n");
                usrWinCnt = usrWinCnt + 1;
                usrWinField.setText(String.valueOf(usrWinCnt));
            }
            if(aiChoice == 3){
                results.append("NPC Selected Scissors. Tie Game!\n\n");
                tieCnt = tieCnt + 1;
                tieCntField.setText(String.valueOf(tieCnt));
            }
        });
        ...
        quitIco = new ImageIcon("src/quitIcon.png");
    ...
    private void CreateWinCntPnl(){
        ...
        userIco = new ImageIcon("src/userIcon.png");
        usrWins = new JLabel("User Win Count", userIco, JLabel.CENTER);
        usrWins.setFont(new Font("Hal9000", Font.PLAIN, 16));
        ...
        tieIco = new ImageIcon("src/drawIcon.png");
        ties = new JLabel("Tie Count", tieIco, JLabel.CENTER);
        ties.setFont(new Font("Hal9000", Font.PLAIN, 16));
        ...
        aiIco = new ImageIcon("src/npcIcon.png");
        aiWins = new JLabel("NPC Win Count", aiIco, JLabel.CENTER);
        aiWins.setFont(new Font("Hal9000", Font.PLAIN, 16));
